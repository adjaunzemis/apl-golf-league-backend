    ...
    with open(file, "r") as fp:
        for line in fp:
            ...
            if (
                ...
                and (line[0].lower() != "#")
                and (line[0].lower() != "<")
            ):  # skip empty, comment, and tag lines
                ...
                if len(line_parts) > 0:
                    ...
                    elif (line_parts[0].lower() != "committees") and (
                        line_parts[0].lower() != "vacant"
                    ):
                        print(line_parts)
...
if __name__ == "__main__":
    ...
    for data_dir in data_dirs:
        ...
        officers_files = [
            f for f in os.listdir(f"data/{data_dir}") if f[0:9] == "officers."
        ]
        for officers_file in officers_files:
            ...
            officers_dict_list = []
            try:
                officers_dict_list = parse_officer_info_file(
                    f"data/{data_dir}/{officers_file}"
                )
            except ValueError:
            ...
            if len(officers_dict_list) == 0:
                ...
                for officer_dict in officers_dict_list:
                    csv_data += "\n" + ",".join(
                        [str(v) for k, v in officer_dict.items()]
                    )
