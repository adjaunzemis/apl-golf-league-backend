...
class TournamentBase(APLGLBase):
    name: str
    year: int
...
class TournamentUpdate(APLGLBase):
    name: str | None = None
    year: int | None = None
    date: datetime | None = None
...
class TournamentInfo(APLGLBase):
    id: int
    year: int
    name: str
    date: str = None
...
class TournamentTeamGolfer(APLGLBase):
    golfer_id: int
    name: str
    role: TeamRole
    division: str
...
class TournamentTeam(APLGLBase):
    tournament_id: int
    team_id: int
    name: str
...
class TournamentStandingsTeam(APLGLBase):
    team_id: int
    team_name: str
    gross_score: int
    net_score: int
...
class TournamentStandingsGolfer(APLGLBase):
    golfer_id: int
    golfer_name: str
...
class TournamentStandings(APLGLBase):
    tournament_id: int
...
class TournamentStatistics(APLGLBase):
    tournament_id: int
    golfers: list[TeamGolferStatistics] = Field(default_factory=list)


class TournamentFreeAgentBase(APLGLBase):
