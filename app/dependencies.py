...
DATABASE_PORT_EXTERNAL = os.environ.get("APL_GOLF_LEAGUE_API_DATABASE_PORT_EXTERNAL")
DATABASE_PORT_INTERNAL = os.environ.get("APL_GOLF_LEAGUE_API_DATABASE_PORT_INTERNAL")
...
try:
    DATABASE_URL = f"{DATABASE_CONNECTOR}://{DATABASE_USER}:{DATABASE_PASSWORD}@{DATABASE_URL}:{DATABASE_PORT_EXTERNAL}/{DATABASE_NAME}"
    engine = create_engine(DATABASE_URL, echo=DATABASE_ECHO)
except:
    DATABASE_URL = f"{DATABASE_CONNECTOR}://{DATABASE_USER}:{DATABASE_PASSWORD}@{DATABASE_URL}:{DATABASE_PORT_INTERNAL}/{DATABASE_NAME}"
    engine = create_engine(DATABASE_URL, echo=DATABASE_ECHO)
