...
def test_compute_hole_maximum_score(par, stroke_index, course_handicap, max_score):
    ...
    assert (
        alhs.compute_hole_maximum_score(par, stroke_index, course_handicap) == max_score
    )
...
def test_compute_hole_handicap_strokes(stroke_index, course_handicap, handicap_strokes):
    alhs = APLLegacyHandicapSystem()
    assert (
        alhs.compute_hole_handicap_strokes(stroke_index, course_handicap)
        == handicap_strokes
    )
...
def test_compute_hole_adjusted_gross_score(
    ...
    alhs = APLLegacyHandicapSystem()
    assert (
        alhs.compute_hole_adjusted_gross_score(
