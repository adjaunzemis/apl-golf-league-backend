...
async def read_team(*, session: Session = Depends(get_session), team_id: int):
    ...
    team_players = get_players_in_teams(session=session, team_ids=(team_id,))
    for player in team_players:
        player.statistics = compute_golfer_statistics_for_matches(player.golfer_id, team_matches)
